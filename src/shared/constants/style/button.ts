...
export const STYLE_BUTTON_VARIANT = {
    ...
    monocrome_white: "text-background border border-background/20 hover:bg-background/10 backdrop-blur-sm",
    monocrome_black: "border border-foreground/20 backdrop-blur-sm",
