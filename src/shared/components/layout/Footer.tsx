...
import { faFacebook, faInstagram, faTiktok, faWhatsapp, faXTwitter } from '@fortawesome/free-brands-svg-icons'
...
export const Footer = async () => {
  ...
  const listSocials = settings.socialMedia && settings.socialMedia.length > 0
